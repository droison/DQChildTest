//
//  Option4ProblemViewController.m
//  ChildTest
//
...
@implementation Option4ProblemViewController
- (void) viewDidLoad
{
    optionCount = 4;
    [super viewDidLoad];
    ...
    btn1.origin = CGPointMake((MMScreenWidth - btn1.width*2 - _optionHInnerMargin)/2, titleImageView.bottom + _optionMarginTop);
    ...
    btn3.origin = CGPointMake(btn1.left, btn1.bottom + _optionVInnerMargin);
...
- (void) onClickNextBtn
{
    if (answerArray.count != 0)
    {
        ...
        UIViewController * vc = [MainService getViewControllerByProblemId:10];
