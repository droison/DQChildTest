...
+(CGSize) screenSize
{
    return CGSizeMake(MMScreenWidth, MMScreenHeight);
}

+(CGSize) screenSizeOri:(UIInterfaceOrientation)orientation
{
    return CGSizeMake(MMScreenWidthOri(orientation), MMScreenHeightOri(orientation));
}

+(CGRect) screenBounds
{
    return CGRectMake(0, 0, MMScreenWidth, MMScreenHeight);
}

+(CGRect) screenBoundsOri:(UIInterfaceOrientation)orientation
{
    return CGRectMake(0, 0, MMScreenWidthOri(orientation), MMScreenHeightOri(orientation));
}
